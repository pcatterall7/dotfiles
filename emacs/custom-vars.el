(custom-set-variables
 ...
 '(package-selected-packages
   '(consult dirvish doom-modeline doom-themes evil evil-collection
             general gptel marginalia markdown-mode minions moody
             olivetti orderless org-appear treemacs treemacs-evil
             vertico which-key)))
(custom-set-faces
